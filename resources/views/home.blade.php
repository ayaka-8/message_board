                        ...
                        <div class="card-body col">
                            ...
                            <div class="solution-group col-12 col card-body px-1 py-2">
                                 <div class="updated_solutions-body row no-gutters flex-column flex-sm-column flex-md-column justify-md-content-around">
                                    　<a class="updated_solutions-body-item col-12 col-sm-12 col-md-12 col pt-2 pb-2 pb-sm-1 pb-md-2 px-1 px-sm-4 px-md-0 text-decoration-none" href="{{ action('SolutionBoardController@show', ['id' => $solution->id]) }}">
